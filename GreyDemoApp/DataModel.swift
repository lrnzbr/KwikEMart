...
let donut = CatalogItem(productName: "Sprinkle Donut", productImage: UIImage(named: "Donut"), productPrice: 0.59, id:"3")
...
let cereal = CatalogItem(productName: "Krusty O's", productImage: UIImage(named: "KrustyCereal"), productPrice: 1.29, id:"8")
let malk = CatalogItem(productName: "Malk", productImage: UIImage(named: "Malk"), productPrice: 1.05, id:"9")
let slushy = CatalogItem(productName: "Squishee", productImage: UIImage(named: "Slushy"), productPrice: 2.49, id:"10")
